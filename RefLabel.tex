...
\begin{theorem}
\label{CompletelyDifferentLabel} This is the third theorem on the page.
\end{theorem}
...
Sadly, only the first of these links to \hyperref[thm:theoremA]{The First Theorem}, \hyperref[thm:theoremB]{The Second Theorem}, \hyperref[CompletelyDifferentLabel]{The Third Theorem}, and \hyperref[thm:theoremD]{The Fourth Theorem} work on the web, even though they all work in the PDF.
