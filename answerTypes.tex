...
\item Multiple Choice Answer Types
  \begin{itemize}
    \item \textbackslash begin\{multipleChoice\} ... \textbackslash end\{multipleChoice\}
    \item (broken) \textbackslash wordChoice
  \end{itemize}    
\item Free Response Answers
  \begin{itemize}   
    \item (broken) \textbackslash begin\{freeResponse\} ... \textbackslash end\{freeResponse\}
  \end{itemize}
\item Code Blocks
  \begin{itemize}
    \item (broken) \textbackslash begin\{code\} ... \textbackslash end\{code\}
    \item (broken) \textbackslash begin\{python\} ... \textbackslash end\{python\}
  \end{itemize}
\item Problems and Exercises
  \begin{itemize}
    \item \textbackslash begin\{problem\} ... \textbackslash end\{problem\}
    \item \textbackslash begin\{question\} ... \textbackslash end\{question\}
    \item \textbackslash begin\{exercise\} ... \textbackslash end\{exercise\}
    \item \textbackslash begin\{exploration\} ... \textbackslash end\{exploration\}
    \item \textbackslash begin\{xarmaBoost\} ... \textbackslash end\{xarmaBoost\}
  \end{itemize}
\end{itemize}
