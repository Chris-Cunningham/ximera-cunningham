...
\item \hyperref[BasicAnswerType]{Basic Answer Types}
  \begin{itemize}
    ...
    \item (broken in print, online) \textbackslash matrixAnswer  
  \end{itemize}
\item \hyperref[MCAnswerType]{Multiple Choice Answer Types}
  \begin{itemize}
    ...
    \item (broken in print, online) \textbackslash wordChoice
  \end{itemize}    
...
\item \hyperref[CodeAnswers]{Code Blocks}
  \begin{itemize}
    \item (broken online) begin\{code\} ... end\{code\}
    \item (broken in print, online) begin\{python\} ... end\{python\}
  \end{itemize}
\item \hyperref[ProblemContainers]{Problems, Exercises, and Hints}
  \begin{itemize}
    ...
    \item (broken in print, online) begin\{shuffle\} ... end\{shuffle\}
...
\item \hyperref[EmbeddedContent]{Embedded Content}
  \begin{itemize}
    \item link
    \item (broken in print) youtube
    \item (broken in print) geogebra
  \end{itemize}
\item \hyperref[Metadata]{Metadata}
  \begin{itemize}
    \item (broken in print) outcome
  \end{itemize}
...
\link[A Cheese Catalog]{http://www.cheese.com}
\end{example}
